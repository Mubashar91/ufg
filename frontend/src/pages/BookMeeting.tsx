...
import { Calendar, Clock, Video, CheckCircle2, ArrowLeft, Menu, X, Phone, Mail, Star, Shield, Inbox, MailCheck, Sparkles } from "lucide-react";
              ...
              >
                <div className="py-6 space-y-4">
                  ...
                  <div className="space-y-2 px-4">
                    ...
                    <motion.a
                      href="mailto:hello@emailproagency.com"
                      className="flex items-center gap-3 p-3 rounded-xl text-muted-foreground hover:text-gold hover:bg-gold/5 transition-all duration-300 group"
                      initial={{ x: -20, opacity: 0 }}
                      animate={{ x: 0, opacity: 1 }}
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="font-semibold">hello@emailproagency.com</span>
                      </div>
                    </motion.a>
                  </div>
                </div>
